...
##CONFIGURAÇÕES
####  TITULO DO MENU  #################################################################
title_menu = '[B][COLOR white]:::[/COLOR][COLOR white]BEM-VINDOS AO ADDON CINE-VIANNA[/COLOR][COLOR white]:::[/COLOR][/B]'
###  DESCRIÇÃO DO ADDON ###############################################################
title_descricao = 'ADDON PARA ENTRETENIMENTO DA SUA FAMÍLIA'
...
desc_favoritos = 'Adicione Itens aos Favoritos, pressionando OK do controle ou clicando o direito e selecionando Adicionar aos favoritos do Cine Vianna'
...
url_origem = 'https://raw.githubusercontent.com/RAPOSO-PAUL/CINE-VIANNA/master/ESCOLHAS'
try:
...
def SKindex():
    #addDir(name,url,mode,iconimage,fanart,description)
    addDir(title_menu,url_title,500,__icon__,'',title_descricao,'','','','','','','','','','','','','','','','')
    if favoritos == 'true':
        addDir(menu_favoritos,'',500,thumb_favoritos,'',desc_favoritos,'','','','','','','','','','','','','','','','')
