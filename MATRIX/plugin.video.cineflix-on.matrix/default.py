...
##CONFIGURAÇÕES
####  TITULO DO MENU  #################################################################
title_menu = '[B][COLOR white]:::[/COLOR][COLOR white]BEM-VINDOS AO ADDON CINE FLIX ON[/COLOR][COLOR white]:::[/COLOR][/B]'
###  DESCRIÇÃO DO ADDON ###############################################################
...
url_origem = 'https://raw.githubusercontent.com/RAPOSO-PAUL/CINE-FLIX-ON/main/ENTRADA'
try:
