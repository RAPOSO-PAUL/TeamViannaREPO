...
def run():
    ...
    # A tela de escolha de ESTILO NAO aparece mais sozinha: ela incomodava,
    # voltando toda hora e ate na TV ESTUARY. Agora o estilo so e escolhido
    # quando a pessoa QUER, entrando no addon (opcao ESTILOS).
